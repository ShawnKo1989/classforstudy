...
//		Q1205. 크기가 3인 정수형 배열 arr1과 크기가 3인 정수형 배열 arr2를 만들고, 
//		두 배열을 1 이상 9 이하의 정수들로 난수 발생하여 채워넣습니다.
//		① 각 배열의 내용을 출력한 후
...
//			배열 arr2의 모든 요소의 합은 7 입니다.
		...
		System.out.print("생성된 배열 arr1 : ");
		System.out.println(Arrays.toString(arr1));
		System.out.print("생성된 배열 arr2 : ");
		System.out.println(Arrays.toString(arr2));
		
		System.out.println("둘중 더 큰 배열의 이름은 "+(sum1>sum2?"arr1":"arr2"+"입니다."));
